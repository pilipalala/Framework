...
public class BannerAnimationActivity extends BaseActivity implements AdapterView.OnItemClickListener {
    Banner banner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        banner.setOnBannerClickListener(new OnBannerClickListener() {
            ...
            public void OnBannerClick(int position) {
                Toast.makeText(BannerAnimationActivity.this, transformers.get(position).toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
