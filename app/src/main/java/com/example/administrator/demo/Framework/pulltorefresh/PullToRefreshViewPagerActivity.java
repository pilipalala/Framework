...
public class PullToRefreshViewPagerActivity extends Activity implements OnRefreshListener<ViewPager> {
    ...
    static class SamplePagerAdapter extends PagerAdapter {
        ...
        private static int[] sDrawables = {R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher};
